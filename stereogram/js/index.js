...
function draw() {
  ...
  image(leftImage,(.5*window.innerWidth+imageMoveX)-leftImage.width,.5*window.innerHeight+imageMoveY, rightImage.width*slider.value(), rightImage.height*slider.value());
  image(rightImage,(.5*window.innerWidth+(leftImage.width*slider.value())-imageMoveX)-leftImage.width,.5*window.innerHeight+imageMoveY, rightImage.width*slider.value(), rightImage.height*slider.value()); 
